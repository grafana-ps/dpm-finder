...
4. Ask for $/1000 active series from the org's FOCUS dataset (Cost Management and Billing → Invoices → FOCUS download, or FOCUS API; prefer Metrics ContractedUnitPrice / ListUnitPrice) before running (required for cost-aware ranking).
